...
public class QnaController {
    ...
    public String setAnswerUpdate(@ModelAttribute AnswerDto answerDto, RedirectAttributes redirectAttributes) {
        // System.out.println(answerDto.getFkBoardQnaId());
        // System.out.println(answerDto.getBoardAnswerContent());

        answerMapper.setAnswerUpdate(answerDto);
        redirectAttributes.addAttribute("id", answerDto.getFkBoardQnaId());
